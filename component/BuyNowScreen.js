...
export default function BuyNowScreen({ navigation }) {
  ...
  const [cardBrand, setCardBrand] = useState("visa"); // 'visa' | 'mastercard'
  ...
  const handleBuyNow = async () => {
    try {
      ...
      // (Bu örnekte ödeme doğrulaması simüle)
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <TextInput
          placeholder={`Card Number (${cardBrand === "visa" ? "Visa" : "Mastercard"})`}
          style={styles.input}
          value={cardNumber}
...
const styles = StyleSheet.create({
  ...
  // Simple Mastercard badge (two overlapping circles)
  mcBadge: {
    width: BADGE_W,
    height: BADGE_H,
    alignItems: "center",
