...
const H_PADDING = 20;
const MINI = 68; // küçük kart boyutu
const GAP = 10;

const toAvatar = (u) =>
  u?.image
    ? `${BASE_URL}/images/${encodeURIComponent(u.image)}?t=${encodeURIComponent(u.updatedAt || Date.now())}`
...
const styles = StyleSheet.create({
  ...
  backCircle: {
    width: 34, height: 34, borderRadius: 17, borderWidth: 1, borderColor: '#E1EDE6',
  ...
  // grid
  miniItem: {
    width: 130, height: 130, borderRadius: 40, overflow: 'hidden',
    backgroundColor: '#F0F6F2', marginBottom: GAP,
  },
