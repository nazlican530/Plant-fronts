...
export default function MyGarden() {
  ...
  // 🔹 Edit akışı: veriyi taslağa kaydet ve AddPlantScreen'e yönlendir
  const startEdit = async (plant, photo) => {
    try {
      const draft = {
        ...
        imageUrl: photo || null, // mevcut görsel (remote)
        // backend alanları:
        categoriesIds:
          plant?.categoriesIds ||
          plant?.categoryIds ||
    ...
    return (
      <View style={styles.card}>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.9}
          onPress={() =>
            navigation.navigate('PlantCareScreen', {
              plant: item,
              imageUrl: photo,
            })
          }
...
const styles = StyleSheet.create({
  ...
  addButton: {
    ...
    width: 74, height: 74, backgroundColor: '#4CAF50',
  ...
  bottomNav: {
    ...
    paddingVertical: 10, borderTopWidth: 1, borderTopColor: "#ddd", backgroundColor: "#fff"
  },
  centerIcon: { backgroundColor: "#5B8E55", padding: 10, borderRadius: 40, alignItems: 'center', justifyContent: 'center' },
});
